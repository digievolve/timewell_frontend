      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center gap-2 group">
           <img src="/images/logo-nobg.png" alt="logo" width={9000} height={9000} className="w-40" />
          </Link>
          ...
          <button
            ...
            className="lg:hidden w-10 h-10 flex items-center justify-center rounded-xl hover:bg-slate-100 transition-colors text-slate-700"
